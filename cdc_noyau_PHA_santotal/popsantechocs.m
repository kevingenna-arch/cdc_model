...
plot(yrs, base.y, '-', ...
	yrs, health30.y, '--', ...
	yrs, health20.y, '-.');
legend('Base', 'Reduction mortalité 45-60', 'Reduction mortalité 25-35', 'Location', 'best');
title('PIB');
...
plot(yrs, base.L_NQ, '-', ...
	...
	yrs, health30.L_Q, '--', ...
	yrs, health20.L_Q, '-.');
legend('Base NQ', 'Reduction mortalité 45-60 NQ', 'Reduction mortalité 25-35 NQ', ...
	'Base Q', 'Reduction mortalité 45-60 Q', 'Reduction mortalité 25-35 Q', ...
	'Location', 'best');
title('Offre de travail');
...
plot(yrs, base.nbar, '-', ...
	yrs, health30.nbar, '--', ...
	yrs, health20.nbar, '-.');
legend('Base', "Reduction mortalité 45-60", 'Reduction mortalité 25-35', ...
	'Location', "best");
title('Travail effectif');
