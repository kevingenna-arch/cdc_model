...
load_params_and_steady_state('./output/ss_cdcsimple_p_STABLE.txt');

%%%%%%%%%%%% STARTING VALS FOR STEADY STATE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

steady;
save_params_and_steady_state('./output/ss_cdcsimple_p_cal.txt');
