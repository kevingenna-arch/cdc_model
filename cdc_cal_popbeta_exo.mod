...
steady;
save_params_and_steady_state('./output/ss_compl_popbeta_exo.txt');
...
writetable(mig_flipped(:, (240:279)+2), './output/mig_shocks_beta.xlsx', 'WriteVariableNames',false, 'WriteRowNames', true);
...
writetable(med_flipped(:, (240:279)+2), './output/med_shocks_beta.xlsx', 'WriteVariableNames',false, 'WriteRowNames', true);