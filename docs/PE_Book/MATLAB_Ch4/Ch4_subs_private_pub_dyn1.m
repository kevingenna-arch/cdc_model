% ----------------------------  Ch4_subs_private_pub_dyn1.m --------------------------------
%   
%   computes steady state (4.26) and tranitionin Chapter 4. of Heer (2018)
%
%   TEMPORARY GOVERNMENT CONSUMPTION INCREASE
%
...
govt=gbar*ones(par.nt+1,1);   % government consumption during transition
govt(1:4)=gtilde*ones(4,1);
par.lfinal=lbar;
par.kfinal=kbar;
par.cpfinal=cpbar;
par.gfinal=gbar;
par.aggctfinal=aggctbar;
...
par1.kold=kbar;
par1.cpold=cpbar;
par1.k0 = kbar;       % needs to be saved in findkinitial
par1.kbar = kbar;
par1.lbar = lbar;
par1.cpbar = cpbar;
...
ngrid = 100;
kgrid = linspace(1.001*kbar,kbar,ngrid);
