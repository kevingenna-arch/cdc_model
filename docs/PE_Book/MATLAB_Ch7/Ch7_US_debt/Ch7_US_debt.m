%   Ch7_US_debt.m
%   computes the steady state in Ch. 7.5 of Heer (2018)
%
...
disp('This program computes the solution to the Steady State');
disp(' ' );
...
taup=0.124;
taupbar=0.124;
%replacement_ratio=0.50;		% gross replacement ratio
...
% 
%
% Step 4: Computation of nitial value for capital-age profile
