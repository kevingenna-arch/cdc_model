...
stderr e_d,inv_gamma_pdf,.0025, Inf; 
stderr e_x,inv_gamma_pdf,.0003, Inf; 
stderr e_c,inv_gamma_pdf,.01, Inf; 
end;


varobs v_d dd dc;

estimation(datafile=AssetPricing_simuldata,mode_compute=6,mh_replic=1000,mh_jscale=.4,nodiagnostic);